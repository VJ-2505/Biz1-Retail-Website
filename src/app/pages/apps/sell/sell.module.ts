...
export class OrderItemModule {
  ...
  constructor(product, options, showname) {
    ...
    this.maxQty = product.maxqty || product.maxQty
    ...
    this.Note = ''
    this.StockBatchId = product.stockBatchId || product.StockBatchId
    this.OptionJson = ''
    this.OptionGroup = []
    this.OrderDiscount = 0
    this.OrderId = 0
...
export class CurrentItemModule {
  ...
  constructor(product) {
    console.log(product)
    this.Id = 0
    this.stockBatchId = +product.stockBatchId || 0
    this.maxQty = product.maxqty || product.maxQty
    this.CompanyId = 0
    this.CategoryId = product.categoryId || product.CategoryId
    ...
    this.Price = product.price || product.Price
    this.Quantity = product.Quantity || 1
    console.log(this.Quantity, product.quantity, product.Quantity)
    this.StatusId = 0
    this.Tax1 = product.tax1 || product.Tax1
    this.Tax2 = product.tax2 || product.Tax2
    this.Tax3 = product.tax3 || product.Tax3
